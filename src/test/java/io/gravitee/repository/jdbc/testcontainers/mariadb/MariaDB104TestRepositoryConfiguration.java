 ...
 */
@Conditional(MariaDB104Condition.class)
public class MariaDB104TestRepositoryConfiguration extends AbstractJdbcTestRepositoryConfiguration {
    ...
    public MariaDBContainer embeddedMariaDB() {
        System.out.println("Start MariaDB 10.4");
        MariaDBContainer container = new MariaDBContainer<>("mariadb:10.4");
        container.start();
        return container;
    }
}