 ...
 */
@Conditional(MySQL57Condition.class)
public class MySQL57TestRepositoryConfiguration extends AbstractJdbcTestRepositoryConfiguration {
    ...
    public MySQLContainer embeddedMysql() {
        System.out.println("Start MySQL 5.7");
