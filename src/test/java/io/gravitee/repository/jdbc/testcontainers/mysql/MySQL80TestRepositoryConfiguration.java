 ...
 */
@Conditional(MySQL80Condition.class)
public class MySQL80TestRepositoryConfiguration extends AbstractJdbcTestRepositoryConfiguration {
    ...
    public MySQLContainer embeddedMysql() {
        System.out.println("Start MySQL 8.0");
